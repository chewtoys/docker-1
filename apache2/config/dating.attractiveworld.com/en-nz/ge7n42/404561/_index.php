<?php /* TITLE: 404 Seite - Kachel */?>
<?php
	include('../../inc/header.inc.php');
	include('../../inc/Log404.class.php');
	Log404::logCall('NZ');
 ?>
<!doctype html>
<html>
			...
			<div class="formular col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
				<div class="row form-header">
					<div class="col-xs-12">
						...
						<p>Join the in-crowd today and get a <br class="visible-xs" />lifetime <i>VIP membership</i>.</p>
					</div>
				</div>
				<form id="form_register" method="post" action="<?php echo $action; ?>" name="form_register" novalidate>
					...
					<div class="row email-row">
						<div class="col-xs-12 col-sm-2 col-sm-offset-2">
							<label for="emailaddy"><?php echo $text_email; ?></label>
						</div>
						<div class="col-xs-12 col-sm-6">
							<input type="email" name="subscribers[email]" placeholder="<?php echo $email_placeholder; ?>" class="" id="emailaddy_404" value="<?php echo $email; ?>" />
						</div>
